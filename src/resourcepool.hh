...
class ResourcePool {
	...
	public:
		...
		std::pair<std::string, Sprite*> make_static_sprite_from_anim(std::string id, Animation* anim, Z_PlaneMeta crop);
		std::pair<std::string, Sprite*> make_static_sprite_from_anim(std::string id, std::string animId, Z_PlaneMeta crop);
