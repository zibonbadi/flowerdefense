...
void Hud::ex_rahmen_create(){
			...
			auto xp_rahmen_mitte = _rc.make_static_sprite_from_texture("tiles.xp_rahmen_mitte", "spritesheet", Z_PlaneMeta{ .u = 32 * 1, .v = 32 * 5, .uw = 32, .vw = 32 }).second;
...
void Hud::ex_bar_create(){
			...
			_rc.add_anim("ex_balken.ex_balken_anzeige", ex_balken_anzeige);
			 ex_bar = _rc.make_sprite_from_anim("ex_balken", "ex_balken.ex_balken_anzeige", Z_PlaneMeta { .x = 0, .y = 0, .w = 0, .h = 0 }).second;
...
void Hud::gaertner_leben_create(){
			...
			_rc.add_anim("gaertner_leben.gaertner_leben_1", gaertner_leben_1);


			 gaertner_leben[0] = _rc.make_sprite_from_anim("gaertner_leben", "gaertner_leben.gaertner_leben_1", Z_PlaneMeta { .x = 0, .y = 32, .w = 32, .h = 32 }).second;
			 gaertner_leben[1] = _rc.make_sprite_from_anim("gaertner_leben", "gaertner_leben.gaertner_leben_1", Z_PlaneMeta { .x = 32 * 1, .y = 32, .w = 32, .h = 32 }).second;
			 gaertner_leben[2] = _rc.make_sprite_from_anim("gaertner_leben", "gaertner_leben.gaertner_leben_1", Z_PlaneMeta { .x = 32 * 2, .y = 32, .w = 32, .h = 32 }).second;
			 gaertner_leben[3] = _rc.make_sprite_from_anim("gaertner_leben", "gaertner_leben.gaertner_leben_1", Z_PlaneMeta { .x = 32 * 3, .y = 32, .w = 32, .h = 32 }).second;
...
void Hud::rose_leben_create(){
			 ...
			 rose_leben_a[3] = new Animation(_rc.get_texture("spritesheet"), 1);
			...
			_rc.add_anim("rose_leben.rose_leben_4", rose_leben_a[3]);
			_rc.add_anim("rose_leben.rose_leben_3", rose_leben_a[2]);
			_rc.add_anim("rose_leben.rose_leben_2", rose_leben_a[1]);
			_rc.add_anim("rose_leben.rose_leben_1", rose_leben_a[0]);

			 rose_leben[3] = _rc.make_sprite_from_anim("rose_leben", "rose_leben.rose_leben_4", Z_PlaneMeta { .x = 32*23, .y = 32, .w = 64, .h = 64}).second;
			 rose_leben[2] = _rc.make_sprite_from_anim("rose_leben", "rose_leben.rose_leben_3", Z_PlaneMeta { }).second;
			 rose_leben[1] = _rc.make_sprite_from_anim("rose_leben", "rose_leben.rose_leben_2", Z_PlaneMeta {  }).second;
			 rose_leben[0] = _rc.make_sprite_from_anim("rose_leben", "rose_leben.rose_leben_1", Z_PlaneMeta { }).second;
